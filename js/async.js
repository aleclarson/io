...
var Either, Promise, Reader, StringOrArray, StringOrBuffer, StringOrNumber, Writer, appendFile, assertType, copyFile, copyTree, emptyFunction, exists, fs, globby, has, isDir, isFile, isLink, makeTree, match, moveTree, openFile, path, promised, readFile, readStats, readTree, removeTree, writeFile;
